...
export default function ProfileOrder(){
    ...
    return(
        <div className="w-[350px] bg-[#ffd39b] text-[#201335] border-[4px] border-[#AC6643] shadow-md rounded-[10px] p-6 text-center font-['Poppins'] transition-all duration-300 hover:-translate-y-2 mt-[60px] ml-[100px] mr-[100px] sticky top-[100px]">
